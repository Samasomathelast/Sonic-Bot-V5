...
if(event.senderID == global.game[event.threadID].player1.id || event.senderID == global.game[event.threadID].player2.id ){
 ...
 message.reply("You don’t have any game running in this group")
      ...
      if(mention.length == 0) return message.reply("__________________&&____\n𝒔'𝒊𝒍 𝒕𝒆 𝒑𝒍𝒂𝒊̂𝒕 𝒎𝒆𝒏𝒕𝒊𝒐𝒏𝒏𝒆 𝒍𝒆 𝒏𝒐𝒎 𝒅𝒆 𝒍𝒂 𝒑𝒆𝒓𝒔𝒐𝒏𝒏𝒆 𝒒𝒖𝒆 𝒕𝒖 𝒗𝒆𝒖𝒙 𝒂𝒇𝒇𝒓𝒐𝒏𝒕𝒆𝒓 🤲💙\n________________________");
...
$cmd install ttt.js module.exports = {
	config: {
		name: "ttt",
    aliases: ['tictactoe'],
		version: "1.1",
